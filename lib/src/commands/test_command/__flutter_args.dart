...
void addFlutterArgs(ArgParser argParser) {
  argParser
    ..addFlag(
...
List<String> getFlutterArgs(ArgParser argParser, ArgResults argResults) {
  ...
  final conflicted = getFlutterConflictingArgs(argParser, argResults);
