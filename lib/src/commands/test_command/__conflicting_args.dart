...
const dartOptions = {'dart-coverage'};

const flutterOptions = {'flutter-coverage'};

void addConflictingArgs(ArgParser argParser) {
  argParser
    ..addFlag(
      'coverage',
      negatable: false,
...
List<String> getDartConflictingArgs(
  ArgParser argParser,
  ...
  final dartCoverage = argResults.wasParsed('dart-coverage');
...
List<String> getFlutterConflictingArgs(
  ArgParser argParser,
  ArgResults argResults,
) {
  final args = <String>{};
